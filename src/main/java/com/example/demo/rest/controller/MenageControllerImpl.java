...
public class MenageControllerImpl implements MenageController<Person> {
    private final MenageService menageService;

    @Override
    @PostMapping("/accrual")
    public ResponseEntity<Person> accrualPoints(@RequestBody BonusDTO bonusDTO) throws Exception {
    ...
    @Override
    @PostMapping("/debit")
    public ResponseEntity<Person> debitingPoints(@RequestBody BonusDTO bonusDTO) {
